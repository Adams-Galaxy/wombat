...
orb -m "$machine" sh -c '
    ...
    test -f "$HOME/.local/share/wombat/build/tree/.gitconfig"
    test -f "$HOME/.local/share/wombat/build/tree/.config/wombat-editor.toml"
    test -f "$HOME/.local/share/wombat/build/tree/.local/wombat-tools/bin/wombat-info"
    test ! -d "$HOME/.local/share/wombat/build/tree/home"
    rg --version | head -1
